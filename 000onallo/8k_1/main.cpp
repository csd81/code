...
int main()
{
    ...
    std::cout << std::endl;
    std::cout << "Vektor teszt: alapkod" << std::endl;
	Vektor v1(4);
	v1.setElem(0,3.5);
	v1.setElem(1,-6.3);
	v1.setElem(2,2.4);
    ...
    std::cout << std::endl;
    std::cout << "Vektor teszt: operator +" << std::endl;
    Vektor v7=v1+v3;
    ...
    std::cout << std::endl;
    std::cout << "Vektor teszt: operator + szammal balrol" << std::endl;
    Vektor v10=4.5+v4;
    ...
    std::cout << std::endl;
    std::cout << "Vektor teszt: operator <<" << std::endl;
    std::cout << v1; // (3.5 , -6.3 , 2.4 , 15)
    std::cout << std::endl;
    std::cout << v2 << std::endl; // (3.5 , -6.3 , 2.4 , 15)
    std::cout << v3 << std::endl << v4 << std::endl << v5 << std::endl << v6 << std::endl;	// (52.3 , 52.4 , 52.5 , 52.6)
                                                                    // (-2.3 , -23 , -25 , -41)
                                                                    // (5.6 , 2.4 , 1.9 , -4)
                                                                    // (-2 , -1.6 , 1.9 , 7.6)
    ...
    std::cout << std::endl;
    std::cout << "Vektor teszt: operator +, -, *, / szammal jobbrol" << std::endl;
    Vektor v20=v3+2.5;
    Vektor v21=v3-2.5;
    Vektor v22=v3*2.5;
    Vektor v23=v3/2.5;
