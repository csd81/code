...
#define PART5 // ActionList beolvasas, printPairs()
...
int main()
{
...
#ifdef PART2
    cout << "--- Arena: printOne() teszt" << endl;
    arena1.printOne("Red_M");
    arena1.printOne("Red_P");
    arena1.printOne("Blue_S");
    cout << endl;
#endif
    ...
    cout << "#04: " << flush;
    arena1.printOne("Red_S1");
    arena1.performAction("Blue_S","Red_S2");
    cout << "#05: " << flush;
    arena1.printOne("Red_S2");
...
#ifdef PART5
    cout << "--- ActionList beolvasas, printPairs()" << endl;
    ActionList actionList("in-actions.txt");
    actionList.printPairs();
    cout << endl;
#endif
