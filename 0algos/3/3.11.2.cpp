...
#include <stdio.h>
#include <string.h>
#include <ctype.h> int main() { char string[] = "The project will scale up to 
1,200 marine sites,\n" "including different conditions such as surface 
...
for (idxI = 0;
idxI < size;
idxI++) { if ( (toupper(string[idxI]) == 'A' || toupper(string[idxI]) == 'E' || 
