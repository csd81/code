...
for (idxI = 0;
idxI < len;
idxI++) { if (result[idxI] == ':') { legyen mindenfele keppen nagybetu 
result[idxI+1] = toupper(result[idxI+1]);
idxI++;
} else if( result[idxI] == 'f' && result[idxI+1] == 'o' && result[idxI+2] == 
'r' && result[idxI+3] == ' ') idxI += 3;
else if (result[idxI] == 'a' && result[idxI+1] == 'n' && result[idxI+2] == 'd' 
&& result[idxI+3] == ' ') idxI += 3;
else if (result[idxI] == 't' && result[idxI+1] == 'h' && result[idxI+2] == 'e' 
&& result[idxI+3] == ' ') idxI += 3;
else if (result[idxI] == 'f' && result[idxI+1] == 'r' && result[idxI+2] == 'o' 
&& result[idxI+3] == 'm' && result[idxI+4] == ' ') idxI += 4;
else if (result[idxI] == 'o' && result[idxI+1] == 'f' && result[idxI+2] == ' ') 
idxI += 2;
else if (result[idxI] == 'i' && result[idxI+1] == 'n' && result[idxI+2] == ' ') 
idxI += 2;
