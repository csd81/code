2.49.1.
#include <stdio.h>
#include <stdlib.h> #define NEV_HOSZ 11 #define INPUT_FILE "in.txt" struct 
TSubscriber { char FirstName[NEV_HOSZ];
...
fee: 2316 Ft Bela Kovacs Longest speaking: 854 Ft Bela Kovacs 2.50. Halmazok 
metszete
