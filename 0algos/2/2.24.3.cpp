...
2.24.3.
#include <stdio.h> float deriv(float posX, float poly4, float poly3, float 
poly2, float poly1, float poly0) { return ( 4*poly4*pow(posX,3) + 
3*poly3*pow(posX,2) + 2*poly2*pow(posX,1) + poly1 );
...
négynél nagyobb! 2.25. Lépésenkénti összegzés
