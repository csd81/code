...
tag pár keresztben van. 2.41. Stopper
2.40.3. <Person> <Name>Jani</Name> <Age>22</Age> <Car> <ID>0</ID> 
<price>50.000000</price> </Car> <Car> <ID>2</ID> <price>12.369000<price> </Car> 
<Car> <ID>21</ID> <price>0.569000</price> </Car> </Person> <Person> 
<Name>Evi</Name> <Age>36</Age> <Car> <ID>6</ID> <price>21.000000</price> </Car> 
<Car> <ID>1<ID> <price>15.400000</price> </Car> </Person> <Person> 
<Name>Zotya</Name> <Age>25</Age> <Car> <ID>3</ID> <price>5.700000</price> 
</Car> </Person>
#include <stdio.h>
#include <stdlib.h>
...
TagIdx = 0;
Found = 0;
if (data[idxI][idxJ] == '<' && data[idxI][idxJ + 1] != '/') { do { tag[TagIdx] 
= data[idxI][idxJ];
TagIdx++;
idxJ++;
...
if (strlen(data[idxI]) > strlen(tag)) { if (strstr(data[idxI], newtag)) { Found 
= 1;
data[idxK][0] = '\0';
