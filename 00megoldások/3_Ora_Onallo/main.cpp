...
// Spec: Készíts a main.cpp-be egy kisebbAtlag függvényt,
// amely paraméterben megkap két Szamsor-t.
// A függvény írja ki, hogy az első vagy a második paraméterben eltárolt számoknak
...
void kisebbAtlag(const Szamsor &sz1, const Szamsor &sz2)
{
    ...
    if (atlag1 < atlag2)
        cout << "Az elso szamsor atlaga kisebb." << endl;
    else if (atlag2 < atlag1)
        cout << "A masodik szamsor atlaga kisebb." << endl;
    else
...
int main()
{
    // A main függvény teljesen lefedi a specifikációban megadott teszteket.
